...
- Preview: https://main--commerce-store--harishtadigital.hlx.page/
- Live: https://main--commerce-store--harishtadigital.hlx.live/
...
1. Open the `commerce-store` directory in your favorite IDE and start coding :)
